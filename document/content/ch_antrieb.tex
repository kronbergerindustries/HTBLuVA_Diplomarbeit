...
Die Nennleistung des Akkumulators übersteigt die Nennleistung von Motor und Motorcontroller, weshalb die Nennwerte dieser Bauteile ebenso relevant für die Dimensionierung der Leitungen und Leitungsschutzorgane ist. Ebenfalls stellen der Motor und die Motorsteuerung zentrale Elemente des E-Motorrades dar, weshalb unter diesem Punkt bestimmte Eigenschaften und Nenndaten genauer beschrieben werden.
...
\begin{align*}
	...
	I_{MACmax} &=	\dfrac{I_{MDCmax}}{\sqrt{3} \cdot cos(\varphi)} = \dfrac{19,5~\mathrm{kW}}{\sqrt{3} \cdot 0,85} \approx 263~\mathrm{A}
\end{align*}
