...
Diese Tabelle wird zum Einloggen in das Programm verwendet und ist mit keiner weiteren Tabelle verbunden. Der Inhalt \footnote{siehe Abschnitt} dieser Tabelle sollte nicht verändert werden. Die Zuweisung der Rechte\footnote{siehe Abschnitt} läuft über den Benutzernamen im Frontend. Die id ist nicht signiert und ist der Primärschlüssel mit Auto-Inkrement.
