...
\begin{lstlisting}[language=Python, caption={Code Starten eines Threads},captionpos=b]
...
In diesem Beispiel wird ein Demon Thread erzeugt und gestartet. Das beudetet dieser Thread wird beim schließen des Programmes automatisch mitgeschlossen und muss dadurch nicht mehr überwacht werden. Das Target ist die Funktion, welche unabhängig ausgeführt werden soll.
...
Über ein \textit{Signal} kann nun über das Back-End der Wert des Balkens verändert werden und in Echtzeit angezeigt werden.
