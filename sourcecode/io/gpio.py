...
relais_1_1 = DigitalOutputDevice(pin=pin_relais_1_1, active_high=True, initial_value=False, pin_factory=None)
relais_1_2 = DigitalOutputDevice(pin=pin_relais_1_2, active_high=True, initial_value=False, pin_factory=None)
relais_1_3 = DigitalOutputDevice(pin=pin_relais_1_3, active_high=True, initial_value=False, pin_factory=None)
relais_1_4 = DigitalOutputDevice(pin=pin_relais_1_4, active_high=True, initial_value=False, pin_factory=None)

# Definieren der Objecte des zeiten Relai Moduls
relais_2_1 = DigitalOutputDevice(pin=pin_relais_2_1, active_high=True, initial_value=False, pin_factory=None)
relais_2_2 = DigitalOutputDevice(pin=pin_relais_2_2, active_high=True, initial_value=False, pin_factory=None)
...
class gpio(object):
	...
	def runner(self):
		...
		button_2_1.when_pressed = relais_2_2
		button_2_1.when_released = relais_2_2

		# Ansteuerung des Relais der Hupe
		button_2_2.when_pressed = relais_1_1.on
		button_2_2.when_released = relais_1_1.off

		# Ansteuerung Taster zum Abblenden
		button_2_3.when_pressed = relais_1_2.off
		button_2_3.when_released = relais_1_2.on

		# Ansteuerung des Relais des Aufbendlichts
		button_2_4.when_pressed = relais_1_2.on
		button_2_4.when_released = relais_1_2.off

		# Ansteuerung des Relais der Hupe
		button_2_5_0.when_pressed = relais_1_3.on
		button_2_5_0.when_released = relais_1_3.off

		# Ansteuerung des Relais der Hupe
		button_2_5_1.when_pressed = relais_1_4.on
		button_2_5_1.when_released = relais_1_4.off